        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {settingsSections.map((section) => (
            <Link
              key={section.href}
              href={section.href}
              className="group bg-card p-6 rounded-[2rem] border border-border shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 relative overflow-hidden"
            >
              <div className="flex flex-col h-full">
                ...
                <p className="text-[11px] font-bold text-muted-foreground leading-relaxed mb-8 flex-grow">
                  {section.description}
                </p>
