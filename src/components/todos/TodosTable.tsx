...
const TodosTable: React.FC<TodosTableProps> = ({
  ...
  return (
    <div className="overflow-x-auto w-full">
      <table className="min-w-[1400px] divide-y divide-border border border-border table-auto">
        <thead className="bg-primary">
          <tr>
            <th className="px-4 py-2 text-left text-xs font-medium text-primary-foreground uppercase whitespace-nowrap">
              #
            </th>
        ...
        <tbody className="bg-background divide-y divide-border">
          {filteredTodos.map((todo, idx) => (
            <tr key={todo.id}>
              ...
              {selectedColumns.includes("task") && (
                <td className="px-4 py-2 text-primary border border-border whitespace-nowrap">
              ...
              {selectedColumns.includes("action") && (
                <td className="px-4 py-2 border border-border">
                  <Menu as="div" className="relative inline-block text-left">
                    ...
                    <MenuItems className="absolute left-0 mt-2 w-40 bg-card border border-border divide-y divide-border rounded-md shadow-lg z-50">
                      <MenuItem>
                        {({ active }) => (
                          <button
